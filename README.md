...
- [svg-react-transformer-loader](https://github.com/mapbox/svg-react-transformer-loader): A Webpack loader for transforming SVG files into React component modules.
...
The following are automatically set (but can be overridden) because they are important for SVG that will be inserted inline into an HTML document:
